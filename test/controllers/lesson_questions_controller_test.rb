...
class LessonQuestionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lesson_question" do
    assert_difference("LessonQuestion.count") do
      post lesson_questions_url, params: { lesson_question: { lesson_id: @lesson_question.lesson_id, order: @lesson_question.order } }, as: :json
    end
  ...
  test "should update lesson_question" do
    patch lesson_question_url(@lesson_question), params: { lesson_question: { lesson_id: @lesson_question.lesson_id, order: @lesson_question.order } }, as: :json
    assert_response :success
  end
